...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations() {
        ...
        return testRequestQueryService.findBy(RequestStatus.LAB_TEST_COMPLETED); // Returns the list of test request which
        //has the status 'LAB_TEST_COMPLETED
    ...
    public List<TestRequest> getForDoctor() {
        ...
        return testRequestQueryService.findByDoctor(doctor); // Returns the list of test requests assigned to
    ...
    public TestRequest updateConsultation(@PathVariable Long id, @RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            User doctor = userLoggedInService.getLoggedInUser(); // finds the current logged in user(doctor)
             ...
             TestRequest testRequest= testRequestUpdateService.updateConsultation(id, testResult, doctor); // updates the
             // consultation for current logged in user(doctor) using id, testResult and user)
