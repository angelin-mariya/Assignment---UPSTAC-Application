...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        User tester =   userLoggedInService.getLoggedInUser();// finds the current logged in user(tester)

        return testRequestQueryService.findByTester(tester); // Returns the list of test requests assigned to
        //current logged in user(tester)
